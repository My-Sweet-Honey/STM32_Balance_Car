...
void MPU6050_GetData(int16_t *GyroX,int16_t *GyroZ)
{
	uint8_t DataH, DataL;
	DataH = mpu6050_read_reg(GYRO_XOUT_H);
	DataL = mpu6050_read_reg(GYRO_XOUT_L);
	*GyroX = (DataH << 8) | DataL;
	
	DataH = mpu6050_read_reg(GYRO_ZOUT_H);
	DataL = mpu6050_read_reg(GYRO_ZOUT_L);
	*GyroZ = (DataH << 8) | DataL;
}
